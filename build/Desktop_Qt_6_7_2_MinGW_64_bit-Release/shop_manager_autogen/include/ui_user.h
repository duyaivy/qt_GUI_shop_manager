...
public:
    ...
    QPushButton *notifyBtn_10;
    QPushButton *notifyBtn_11;
    QPushButton *notifyBtn_12;
    QLabel *label_21;
    QLabel *label_22;
    QLabel *label_23;
    QLineEdit *lineEdit;
...
"border:none;"));
        ...
        notifyBtn_10 = new QPushButton(widget_2);
        notifyBtn_10->setObjectName("notifyBtn_10");
        notifyBtn_10->setGeometry(QRect(430, 110, 31, 31));
        notifyBtn_10->setFont(font16);
        notifyBtn_10->setCursor(QCursor(Qt::CursorShape::PointingHandCursor));
        notifyBtn_10->setStyleSheet(QString::fromUtf8("border-radius: 15px;\n"
"background-color:#E7EDFF;\n"
"border:none;"));
        notifyBtn_10->setIcon(icon13);
        notifyBtn_10->setIconSize(QSize(20, 20));
        notifyBtn_11 = new QPushButton(widget_2);
        notifyBtn_11->setObjectName("notifyBtn_11");
        notifyBtn_11->setGeometry(QRect(430, 180, 31, 31));
        notifyBtn_11->setFont(font16);
        notifyBtn_11->setCursor(QCursor(Qt::CursorShape::PointingHandCursor));
        notifyBtn_11->setStyleSheet(QString::fromUtf8("border-radius: 15px;\n"
"background-color:#E7EDFF;\n"
"border:none;"));
        notifyBtn_11->setIcon(icon13);
        notifyBtn_11->setIconSize(QSize(20, 20));
        notifyBtn_12 = new QPushButton(widget_2);
        notifyBtn_12->setObjectName("notifyBtn_12");
        notifyBtn_12->setGeometry(QRect(430, 250, 31, 31));
        notifyBtn_12->setFont(font16);
        notifyBtn_12->setCursor(QCursor(Qt::CursorShape::PointingHandCursor));
        notifyBtn_12->setStyleSheet(QString::fromUtf8("border-radius: 15px;\n"
"background-color:#E7EDFF;\n"
"border:none;"));
        notifyBtn_12->setIcon(icon13);
        notifyBtn_12->setIconSize(QSize(20, 20));
...
"color: blue;"));
        ...
        QObject::connect(notifyBtn_6, &QPushButton::clicked, notifyBtn_2, qOverload<>(&QPushButton::click));
        QObject::connect(notifyBtn_7, &QPushButton::clicked, notifyBtn_2, qOverload<>(&QPushButton::click));
        QObject::connect(notifyBtn_8, &QPushButton::clicked, notifyBtn_2, qOverload<>(&QPushButton::click));
        QObject::connect(notifyBtn_9, &QPushButton::clicked, notifyBtn_2, qOverload<>(&QPushButton::click));
        QObject::connect(notifyBtn_11, &QPushButton::clicked, notifyBtn_2, qOverload<>(&QPushButton::click));
        QObject::connect(notifyBtn_10, &QPushButton::clicked, notifyBtn_2, qOverload<>(&QPushButton::click));
        QObject::connect(notifyBtn_12, &QPushButton::clicked, notifyBtn_2, qOverload<>(&QPushButton::click));
    ...
    void retranslateUi(QMainWindow *user)
    {
        ...
        notifyBtn_10->setText(QString());
        notifyBtn_11->setText(QString());
        notifyBtn_12->setText(QString());
